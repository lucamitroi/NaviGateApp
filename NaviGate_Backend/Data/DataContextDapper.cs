...
public class DataContextDapper
{
    ...
    // Function to get a single object from the Database based of an SQL Query with params
    public T? LoadSingleDataNoError<T>(string sql, object? parameters = null)
{
    IDbConnection dbConnection = new SqlConnection(_config.GetConnectionString("DefaultConnection"));
